...
// hech bo'lmasa bitta kerakli qism o'tmadi bo'lsa va boshqa kutilayotgan qism
// yo'q bo'lsa) — va default qaysi qismlar (nazariy/amaliy) tanlanishi kerak.
export function qaytaBiriktirishKerakmi(urinishlar) {
  ...
  const nazariyOtmadi = nazariyHolat === "otmadi";
  const amaliyOtmadi = amaliyHolat === "otmadi";
  if (!nazariyOtmadi && !amaliyOtmadi) return null;
  return { nazariyKerak: nazariyOtmadi, amaliyKerak: amaliyOtmadi };
}
